...
### Running
**Note**: The main_1.py and main_2.py of DeepSpa supports Linux, MacOS and Windows platform, but 3D_point_cloud.py only support in MacOS or Windows platform.
...
```
**Note**: The code runs on the server by default. If running on a local terminal, please pay attention to the path format.
