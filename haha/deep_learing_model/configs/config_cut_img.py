...
target_data_root = 'data/tissuenet_1.0/'
img_norm_cfg = dict(
...
uda = dict(
    ...
    # domaindiscriminator=dict(type='DomainDiscriminator', num_classes=2),
    # blur=True,
    # color_jitter_strength=0.2,
    # color_jitter_probability=0.2,
    # pseudo_start_iter=3500
)
...
work_dir = './work_dirs/cellpose/dsb2018_mitb0_norm99_bs4/'
